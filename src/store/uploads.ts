...
import { uploadFileStorage } from "../http/upload-file-to-storage";
  ...
  immer((set, get) => {
    ...
    async function processUpload(uploadId: string) {
      ...
      try {
        ...
        updateUpload(uploadId, { compressedSizeInBytes: compressFile.size });

        const { url } = await uploadFileStorage(
          {
            file: compressFile,
